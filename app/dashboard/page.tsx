        ...
        <main style={{ flex: 1, padding: '32px', overflowY: 'auto', maxWidth: 'calc(100% - 220px)' }}>
            ...
            <>
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: 15 }}>
                  Here's your activity overview — keep building that profile!
                </p>
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 32 }}>
            {[
              ...
              { label: 'Badges Earned', value: earnedBadges.length, icon: Award, color: '#8b5cf6', link: '/activities' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 24 }}>
            ...
            <div className="card" style={{ padding: '24px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 18 }}>
                ...
                <h2 style={{ fontSize: 15, fontWeight: 700 }}>Progress to Next Milestone</h2>
              </div>
              <div style={{ marginBottom: 14 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, marginBottom: 8 }}>
                  <span style={{ color: 'var(--text-secondary)', fontWeight: 500 }}>{totalHours}h completed</span>
                  <span style={{ color: 'var(--accent-light)', fontWeight: 700 }}>{nextMilestone}h goal</span>
                </div>
                <div className="progress-bar" style={{ height: 10 }}>
                  <div className="progress-fill" style={{ width: `${progressPct}%` }} />
                </div>
                <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 6 }}>
                  {nextMilestone - totalHours} more hours to unlock next badge!
                </div>
              </div>

              {/* All Available Badges */}
              <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid var(--border-subtle)' }}>
                <h3 style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-secondary)', marginBottom: 12 }}>Available Milestones</h3>
            ...
            <div className="card" style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {[
                  ...
                  { label: 'Generate resume bullet', desc: 'AI-powered in seconds', icon: Sparkles, href: '/ai-tools', color: '#f59e0b' },
                  { label: 'Track an application', desc: `${applications.length} in progress`, icon: Send, href: '/applications', color: '#10b981' },
                  { label: 'Update your profile', desc: 'Keep it fresh for colleges', icon: CheckCircle, href: '/profile', color: '#ec4899' },
